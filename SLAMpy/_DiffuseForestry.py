...
class ForestryV1(object):
    ...
    def getParameterInfo(self):
        ...
        return [out_gdb, out_fld,
                ...
                in_forest, in_factors_n, in_factors_p]

    def execute(self, parameters, messages):
        # retrieve parameters
        out_gdb, out_fld, project_name, nutrient, region, selection, in_forest, in_factors_n, in_factors_p = \
...
def forestry_v1_geoprocessing(project_name, nutrient, location, in_forest, in_factors, out_gdb, messages,
    ...
    arcpy.SelectLayerByAttribute_management('lyrForestry', "NEW_SELECTION", "CODE_12 LIKE '3%'")
